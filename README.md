...
LLM Research Engineer를 목표로 학습 기록, 개념 지식, 실행 실습을 연결해 쌓아가는 개인 학습 저장소입니다.

완벽한 학습 관리 시스템보다 **나중에 다시 찾을 수 있는 짧은 기록**을 우선합니다.

[사용법](./USAGE.md) · [학습 로드맵](./ROADMAP.md) · [역량·자료 기준](./CURRICULUM.md)

## 구조

| 위치 | 용도 |
|---|---|
| [`materials/`](./materials/) | 강의자료와 원본 자료 |
